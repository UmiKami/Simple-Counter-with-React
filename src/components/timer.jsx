	...
	return (
		<div className="timer">
            ...
            <div className="counter-input">
                <input type="number" className='timeInpt' onChange={getValue}/>
                <button className='btn' type='button' onClick={setTime}>Change Time</button>
                <button className='btn' type='button' onClick={()=>isGoingUp = true}>▲</button>
                <button className='btn' type='button' onClick={()=>isGoingUp = false}>▼</button>
            </div>
		</div>
	);
};
